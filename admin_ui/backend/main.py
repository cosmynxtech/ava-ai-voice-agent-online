...
from api import config, system, wizard, logs, ollama, mcp, calls, outbound, tools, docs  # noqa: E402
# NOTE: local_ai has been removed in the online-only variant
# from api import local_ai  # Removed for online-only version
...
# NOTE: local_ai router removed in online-only variant
